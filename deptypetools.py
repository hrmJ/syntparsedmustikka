...
def makeSearch(ConditionColumns,database,dbtable,headcond=None,depcond=None,headdepcond=None, finheaddepcond=None,appendconditioncolumns=True,isparallel=False,extralog='',limited=None, monoling=False):
